  ...
  return (
    <div className="wrapper">
      ...
      <div className="text-lg tracking-wide flex flex-col gap-6">
        <p>
          I am a software developer with 7+ months of experience in JavaScript.
          ...
          using JavaScript and its ecosystem. I have experience working on a
          variety of projects, including building and maintaining single page
          applications, integrating with REST APIs, and implementing responsive
          design principles. I am also proficient in using tools such as
          Webpack, npm, and Git for development and deployment. In addition to
          my technical skills, I am a strong communicator and team player. I am
          able to work effectively with cross-functional teams and am
